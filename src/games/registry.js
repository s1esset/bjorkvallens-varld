...
import blixtOchDunder from './blixt-och-dunder/index.js'
import kugghjulen from './kugghjulen/index.js'
import gravmaskinen from './gravmaskinen/index.js'
import trollblandning from './trollblandning/index.js'
import loopdjuren from './loopdjuren/index.js'
import pizzabageriet from './pizzabageriet/index.js'
import hamburgerbygget from './hamburgerbygget/index.js'
import glittergrottan from './glittergrottan/index.js'
import zackesBiltvatt from './zackes-biltvatt/index.js'
import saftbaren from './saftbaren/index.js'
import natskottPaStan from './natskott-pa-stan/index.js'
import skattjaktIMorkret from './skattjakt-i-morkret/index.js'
import passaFormerna from './passa-formerna/index.js'
import balanstornet from './balanstornet/index.js'
import leksakslada from './leksakslada/index.js'
import byggEnKompis from './bygg-en-kompis/index.js'
import roligaSnurran from './roliga-snurran/index.js'
import elementlekplatsen from './elementlekplatsen/index.js'
import tittUtPappa from './titt-ut-pappa/index.js'
import vaknaPappa from './vakna-pappa/index.js'
import fluganPaNasan from './flugan-pa-nasan/index.js'
import borstaTanderna from './borsta-tanderna/index.js'
import unikaKnytt from './unika-knytt/index.js'
import grodanSlurp from './grodan-slurp/index.js'
import popcornkalaset from './popcornkalaset/index.js'

export const GAMES = [klambubblor, sorteraSkrap, vandkort, poppaBallonger, tryckOchForvandla, kittlaFiguren, fargregn, mataMonstret, raknaApplen, klappaMullvaden, pekaPaKroppen, vilketDjurLater, storLiten, tartaIAnsiktet, klaPaNallen, planteraFron, skuggmatchning, enkeltPussel, plaskIVattnet, klaEfterVadret, vartTogDetVagen, vadForsvann, byggTornet, rullaBollenHem, siffertaget, sparaLinjen, harmaMelodin, foljSparet, studsbollar, djurorkester, studsaNer, fyrverkeri, fangaFrukten, vippbradan, domino, studsmatta, sapbubblor, knuffaTornet, spindelhjalten, enhorningenElvira, bajsOchKiss, regnbagsmalaren, pruttbad, valpensBajs, enhorningGlitterbajs, tvattaDjuret, ballonglyft, gungan, lagerelden, spindelnatet, magnetFiske, fallskarmen, enhorningenFlyger, spindelZackeSvingar, bowling, flipperspel, kulbana, snobollen, glasstornet, golvetArLava, vattenvagen, blixtOchDunder, kugghjulen, gravmaskinen, trollblandning, loopdjuren, pizzabageriet, hamburgerbygget, glittergrottan, zackesBiltvatt, saftbaren, natskottPaStan, mataMunnen, skattjaktIMorkret, passaFormerna, balanstornet, leksakslada, byggEnKompis, roligaSnurran, elementlekplatsen, tittUtPappa, vaknaPappa, fluganPaNasan, borstaTanderna, unikaKnytt, grodanSlurp, popcornkalaset]
